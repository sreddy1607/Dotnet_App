        ...
        container('mspdotnet') {
          script {
                ...
                sh '''
                  ...
                  curl -kv -u service-account:$TOKEN --upload-file Dotnet_App/Dockerfile -H "Authorization: Bearer $TOKEN" "https://nexusrepo-tools.apps.bld.cammis.medi-cal.ca.gov/repository/cammis-dotnet-repo-group/Dockerfile"
                '''
            }
        }
    }
