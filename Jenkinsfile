            ...
            - name: jnlp
              ...
              envFrom:
                - configMapRef:
                    ...
                    optional: true
            - name: maven
              image: registry.redhat.io/jboss-webserver-6/jws60-openjdk17-openshift-rhel8:latest
              tty: true
              command: ["/bin/bash"]
              securityContext:
                privileged: true
          ...
          script {
            properties([
              parameters([
                ...
                gitParameter(name: 'GIT_TAG', defaultValue: 'tar-purge-app_deployed_in_dev_dev_from_master', description: 'git tag', type: 'PT_TAG'),
