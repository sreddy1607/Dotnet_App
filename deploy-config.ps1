...
DEL /S /Q E:\tar-surge-Api-staging\Apiservices\*

DEL /S /Q E:\tar-surge-Api-staging\serverconfig\*
DEL /S /Q E:\tar-surge-Api-staging\environment\*
DEL /S /Q E:\tar-surge-Api-staging\scripts\*
